...
const employeeTabs = new Tabs("employeeTabs", {
  list: "employee__nav",
...
var index_select = __webpack_require__(7854);
...
;// CONCATENATED MODULE: ./src/js/components/index-hovers.js
function makeHovers() {
...
if (document.querySelector(".hero")) {
  lib_axios.get("http://localhost:3000/salaryData").then(r => {
    sliderData = r.data;
    makeSlider();
    makeHovers();
    hideLoader();
...
function makeSlider() {
  ...
  if (lastSlideRows.length !== chunkSize) {
    lastSlideRows[lastSlideRows.length - 1].style.boxShadow = "0 -1px 0 var(--hero-border-color), 0 1px 0 var(--hero-border-color)";
  }
...
var Scheduler = (function () {
    ...
    Scheduler.prototype.start = function () {
        ...
        if (this.stopped) {
            ...
            this.observe();
            scheduler_events.forEach(function (name) { return global_global.addEventListener(name, _this.listener, true); });
        }
    };
    Scheduler.prototype.stop = function () {
        ...
        if (!this.stopped) {
            ...
            scheduler_events.forEach(function (name) { return global_global.removeEventListener(name, _this.listener, true); });
            this.stopped = true;
        }
    };
    return Scheduler;
...
;// CONCATENATED MODULE: ./src/js/components/employee-scrollbar.js
